...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        End If
        If (checkpcd.Checked = True Or checkabastecimento.Checked = True Or checkpocos.Checked = True Or checkdessalinizadores.Checked = True Or checkoutorgas.Checked = True Or checkmonitoramento.Checked = True) Then
...
<label for="checkmonitoramento" class="menu-title">Pontos de Monitoramento</label></a>
         ...
         stylers: [
           { visibility: "off" }
                                                 ...
                                                 function initMap() {
                                                   ...
                                                   //Municípios
                                                      ...
                                                      if (document.getElementById('checkmunicipios').checked == true)  {  
                                                        ...
                                                        municipios.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/municipios_rn.geojson');
                                                    ...
                                                    if (document.getElementById('checkdessalinizadores').checked == true) {
                                                        ...
                                                        dessalinizadores.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/dessalinizadores_rn2.geojson');
                                                    ...
                                                    if (document.getElementById('checkpocos').checked == true) {
                                                        ...
                                                        pocos.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/pocos_semarh_rn_2.geojson');
                                                    ...
                                                    if (document.getElementById('checkaquiferos').checked == true) {
                                                        ...
                                                        aquiferos.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/aquiferos_rn5.geojson');
                                                    ...
                                                    if (document.getElementById('checkabastecimento').checked == true) {
                                                        ...
                                                        abastecimento.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/sistemas_abastecimento_agua_rn3.geojson');
                                                        ...
                                                        adutorassaa.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/adutoras_saa_rn.geojson');
                                                    ...
                                                    if (document.getElementById('checkbacias').checked == true) {
                                                        ...
                                                        bacias.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/bacias_hidro_rn.geojson');
                                                ...
                                                cursos.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/cursos_dagua_rn2.geojson');
                                            ...
                                            function createClickablePolyCursos(poly, map) {
                                                ...
                                                massasdagua.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/massas_dagua_rn4.geojson');
                                               ...
                                               if (document.getElementById('checkadutoras').checked == true) {
                                                       var adutoras = new google.maps.Data();
                                                        adutoras.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/adutoras_rn3.geojson');
                                         ...
                                         if (document.getElementById('checkpcd').checked == true) {
                                                        ...
                                                        pcds.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/pcds_rn.geojson');
                                         ...
                                         if (document.getElementById('checkoutorgas').checked == true) {
                                                        ...
                                                        outorgasana.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/outorgas_ana_rn2.geojson');
                                                       ...
                                                       function createClickableMarkerOutorgasana(marker, map) {
                                                        ...
                                                        outorgasigarnobras.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/outorgas_obra_igarn_rn2.geojson');
                                                       ...
                                                       function  createClickableMarkerOutorgasIgarnObras(marker, map) {
                                                        ...
                                                        outorgasigarndis.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/outorgas_dispensa_igarn_rn2.geojson');
                                                        map: map
                                                        ...
                                                        iconeoutigarndis='images/marcadores/Outorgas.png';
                                                        return({
                                                       ...
                                                       function  createClickableMarkerOutorgasIgarnDis(marker, map) {
                                                        ...
                                                        outorgasigarnuso.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/outorgas_uso_igarn_rn.geojson');
                                                        map: map
                                                        ...
                                                        iconeoutigarnuso='images/marcadores/Outorgas.png';
                                                        return({
                                            ...
                                            //Monitoramento
                                                     ...
                                                     if (document.getElementById('checkmonitoramento').checked == true) {
                                                        ...
                                                        monitoramentosuperficial.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/monitoramento_superficial_rn.geojson');
                                                       ...
                                                       function createClickableMarkerMonitoramentoSup(marker, map) {
                                                        ...
                                                        monitoramentosubterraneo.loadGeoJson('https://dl.dropboxusercontent.com/u/26549106/monitoramento_subterraneo_rn.geojson');
